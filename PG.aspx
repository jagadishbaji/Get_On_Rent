...
<body>
	...
	<div style="width:90%;margin-left:5%;margin-right:5%;">
		...
		<div class="panel-body">
		 <div class="pro-sort" style="width:28%">
              ...
              <asp:DropDownList ID="dd_for" 
									  runat="server" OnSelectedIndexChanged="dd_for_SelectedIndexChanged" AutoPostBack="true" CssClass="form-control" 
									 >
	...
	<asp:Repeater ID="rptr_View" runat="server">
	   <ItemTemplate>
		...
		<p style="margin-left:82%;margin-top:-13%">Landline :<%#DataBinder.Eval(Container.DataItem,"Landline") %></p>
		...
		<p>Capasity/Room:<%#DataBinder.Eval(Container.DataItem,"Capasity") %></p>
		<p style="margin-left:82%;margin-top:-13%">Security :<%#DataBinder.Eval(Container.DataItem,"Security") %></p>
		<p>Bath Rooms:<%#DataBinder.Eval(Container.DataItem,"BathRoom") %></p>
		<p style="margin-left:82%;margin-top:-13%">Sqft :<%#DataBinder.Eval(Container.DataItem,"Sqft") %></p>
		<p>WiFi :<%#DataBinder.Eval(Container.DataItem,"wifi") %></p>
